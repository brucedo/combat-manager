...
use super::{PlayerId, CharacterId, registry::GameRegistry, dispatcher::Outcome, GameId};
...
pub fn into_notification(game_directory: &GameRegistry, outcome: &Outcome, game_id: &GameId, player_id: &PlayerId) -> Option<WhatChanged>
{
    match outcome {
